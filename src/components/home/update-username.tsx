...
import { checkUsernameAvailability, updateUsername } from '@lib/supabase/utils';
...
export function UpdateUsername(): JSX.Element {
  ...
  return (
    <>
      <Modal
        modalClassName='flex flex-col gap-6 max-w-xl glass-morphism-strong w-full p-8 rounded-2xl h-[576px]'
        open={open}
